...
find_python() {
  for candidate in python3 python; do
    ...
    # Cockpit richiede Python 3.11 o successivi
...
UV_BIN="$(find_uv || true)"
if [ -n "$UV_BIN" ]; then
  echo "Avvio rapido con uv (ambiente Python 3.12+ automatico)..."
...
if [ -z "$PYTHON_BIN" ]; then
  ...
  echo "Su macOS 12+ il Python di sistema è troppo datato."
